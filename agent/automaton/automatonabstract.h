...
public:
	...
	:table(table){}
	virtual std::forward_list<automaton_state> getNextAutomatonState(std::forward_list<automaton_state>const& oldStates, std::map<transition,Events>const& event)=0; 
