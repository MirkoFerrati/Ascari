...
public:
	...
	{
		this->init_full(agent_name,"tcp://127.0.0.1:5555","tcp://127.0.0.1:5556","tcp://127.0.0.1:5557");
	}
};
...
public:
	...
	{
		this->init_full("simulator","tcp://127.0.0.1:5556","tcp://127.0.0.1:5555","tcp://127.0.0.1:5557",expected_senders);
	}
};