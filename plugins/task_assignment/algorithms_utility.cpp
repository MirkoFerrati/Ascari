...
{
	return norm2(*x,*y,reinterpret_cast<const task_assignment_namespace::task*>(tasks.at(task_id)->getState())->task_position[0],reinterpret_cast<const task_assignment_namespace::task*>(tasks.at(task_id)->getState())->task_position[1]);
}
